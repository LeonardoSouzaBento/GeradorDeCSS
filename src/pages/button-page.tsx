...
import { InitialSize, RelativeSizes, WeightSelector } from './button-page/font-styles/index';
import { CSSReturn, Nav, OptionsMenu, Preview, RemoveHeaderButton } from './button-page/index';
              ...
              <CardContent
                ...
                {navOptions === 'Outline' && (
                  <OutlineInput
                    ...
                    setOutlineValue={setOutlineValue}
                    ghostOutline={ghostOutline}
                    setGhostOutline={setGhostOutline}
                  />
                )}
